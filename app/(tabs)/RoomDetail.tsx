  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.allContainer}>
          <Text style={styles.header}>나의 파티</Text>
        ...
        <View style={styles.ticketContainer}>
          ...
          <Text style={styles.Label}>인원수</Text>
            <Text style={styles.passengerCount}>{room.users ? room.users.length : 0}/{room.limit_people}</Text>
          </View>
          {/* 4. 장소 정보 */}
          <View style={styles.placeSection}>
          <Text style={styles.Label}>만남의 장소</Text>
            <Text style={styles.detailsText}>상세사항으로 받은 데이터를 만남의장소와 옷차림으로 쪼개서 db로 받고 글자수 제한 필요어디까지 받을건지 확인 필요 3줄 정도만
            </Text>
          </View>
          </View>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.iconButton} >
              <Ionicons name="chatbubble-outline" size={32} onPress={() => navigation.navigate('Chat')}/>
